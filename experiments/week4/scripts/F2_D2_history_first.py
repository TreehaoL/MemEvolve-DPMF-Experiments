...
from F2_D2_memory_provider import F2D2MemoryProvider
...
CLEAN_WORK_PATH = Path(
    "experiments/week4/results/F2_D2_clean_working_memory.json"
)

POISONED_WORK_PATH = Path(
    "experiments/week4/results/F2_D2_poisoned_working_memory.json"
)

RESULT_PATH = Path(
    "experiments/week4/results/F2_D2_history_first.json"
)
...
summary = {
    "experiment": "week4_F2_D2_history_first",
    "created_at": (
        datetime.now()
        .astimezone()
        .isoformat()
...
print()
print("=" * 72)
print("F2 x D2 HISTORY-FIRST SUMMARY")
print("=" * 72)
