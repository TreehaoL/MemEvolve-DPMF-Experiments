...
CLEAN_WORK_PATH = Path(
    "experiments/week4/results/F2_clean_working_memory.json"
)

POISONED_WORK_PATH = Path(
    "experiments/week4/results/F2_poisoned_working_memory.json"
)

RESULT_PATH = Path(
    "experiments/week4/results/F2_topk3_baseline.json"
)
...
summary = {
    "experiment": "week4_F2_topk3_baseline",
    "created_at": (
        datetime.now()
        .astimezone()
        .isoformat()
...
print()
print("=" * 72)
print("F2 TOP-K=3 BASELINE SUMMARY")
print("=" * 72)
