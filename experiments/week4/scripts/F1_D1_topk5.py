...
FILTERED_POISONED_PATH = Path(
    "experiments/week4/results/F1_D1_filtered_poisoned_memory.json"
)

RESULT_PATH = Path(
    "experiments/week4/results/F1_D1_topk5.json"
)
...
print("=" * 72)
print("F1 FILTER BEFORE D1 RETRIEVAL")
print("=" * 72)
...
print()
print("=" * 72)
print("F1 x D1 EXPERIMENT SUMMARY")
print("=" * 72)
print(
    json.dumps(
        summary["metrics"],
